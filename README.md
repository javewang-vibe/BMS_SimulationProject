...
![LSTM 预测SOC 结果](data_overview.png)(training_history.png)(prediction_result.png)
## 环境要求
...
![LSTM predict SOC results](data_overview.png)(training_history.png)(prediction_result.png)
